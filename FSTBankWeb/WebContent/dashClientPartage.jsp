		...
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2>
						<i class="glyphicon glyphicon-star-empty"></i>Compte particulier partagée client
					</h2>
				</div>
					...
					<div class="box-content">
						...
						<c:choose>
							...
							<c:otherwise>
								<div
									style="font-size: 120px; letter-spacing: 4px; text-align: center;"
									class="alert alert-danger">vous n'aver pas un compte particulier partagée</div>
							</c:otherwise>
						</c:choose>
						...
						<div class="modal fade" id="exampleModal" tabindex="-1"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<form action="DashClientPartage" method="post">
